...
LOCATION_EXCLUDE_TERMS = [
    # Welsh cities outside commute zone
    "cardiff",
    "swansea",
    "newport",
    "aberystwyth",
    # English cities outside commute zone
    "bristol",
    "liverpool",
    "leeds",
    "sheffield",
    ...
    "st andrews",
    "belfast",
    # Common university name patterns that indicate distant locations
